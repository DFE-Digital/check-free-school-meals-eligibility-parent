...
public class BulkCheckControllerArchived : BaseController
{
    ...
    public BulkCheckControllerArchived(ILogger<BulkCheckControllerArchived> logger, ICheckGateway checkGateway,
    ...
    public IActionResult Bulk_Check_Old()
    {
